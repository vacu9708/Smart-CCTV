...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, confidences, classes, ori_img, parking_list, cam, client_socket):
        ...
        self.tracker.update(detections, classes, confidences, self.parked_car_num, parking_list, cam, client_socket, ori_img)
